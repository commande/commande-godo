...
- Emailing a todo requires that the email client be setup ahead of time. If the email client on the phone is not setup, you will receive an error that the action is not supported.
